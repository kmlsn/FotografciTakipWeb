...
namespace FotografciTakipWeb.App_Settings
{
    ...
    {
        string hash = "Ikra bismi rabbikellezî halak. Halakal insane min alak. Ikra ve rabbukel ekrem. Ellezî alleme bil kalem. Allemel insane ma lem yalem.";
