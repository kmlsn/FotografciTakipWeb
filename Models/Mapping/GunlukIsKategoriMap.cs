...
{
    public class GunlukIsKategoriMap : EntityTypeConfiguration<GunlukIsKategori>
    {
        public GunlukIsKategoriMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.HasRequired(t => t.Firma)
                .WithMany(t => t.GunlukIsKategoris)
