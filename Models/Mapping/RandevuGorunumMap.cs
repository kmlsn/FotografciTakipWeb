...
{
    public class RandevuGorunumMap : EntityTypeConfiguration<RandevuGorunum>
    {
        public RandevuGorunumMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);

            // Properties
            this.Property(t => t.Gorunum)
                .IsRequired()
                .HasMaxLength(250);

            // Table & Column Mappings
            this.ToTable("RandevuGorunum");
