...
{
    public class LisanslarMap : EntityTypeConfiguration<Lisanslar>
    {
        public LisanslarMap()
        {
            // Primary Key
            ...
            this.ToTable("Lisanslar");
            this.Property(t => t.Id).HasColumnName("Id");
            this.Property(t => t.FirmaId).HasColumnName("FirmaId");
            this.Property(t => t.KayitTarihi).HasColumnName("KayitTarihi");
            this.Property(t => t.LisansBaslangicTarihi).HasColumnName("LisansBaslangicTarihi");
            this.Property(t => t.LisansYenilemeTarihi).HasColumnName("LisansYenilemeTarihi");
            this.Property(t => t.LisansBitisTarihi).HasColumnName("LisansBitisTarihi");
